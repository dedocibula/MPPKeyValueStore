...
public final class MPPClient implements KeyValueStoreClient {
    ...
    private <T extends Serializable> Future<T> executeAsync(MPPCommand command, Class<T> resultType) {
    ...
    private static final class MPPResponseHandler<T extends Serializable> implements CompletionHandler<Integer, MPPConnection> {
    ...
    private static final class MPPResponseFuture<T extends Serializable> implements Future<T> {
