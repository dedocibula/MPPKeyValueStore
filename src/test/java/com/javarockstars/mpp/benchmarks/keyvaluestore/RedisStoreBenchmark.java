...
import static com.javarockstars.mpp.benchmarks.BenchmarkConstants.REDIS_PORT;
 ...
 */
public class RedisStoreBenchmark extends KeyValueStoreBenchmark {
    public RedisStoreBenchmark() {
        super(KeyValueStoreType.REDIS, new InetSocketAddress(SERVER_HOSTNAME, REDIS_PORT));
    }
