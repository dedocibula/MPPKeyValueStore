...
import static com.javarockstars.mpp.benchmarks.BenchmarkConstants.MPP_PORT;
 ...
 */
public class MPPStoreBenchmark extends KeyValueStoreBenchmark {
    public MPPStoreBenchmark() {
        super(KeyValueStoreType.MPP, new InetSocketAddress(SERVER_HOSTNAME, MPP_PORT));
    }
